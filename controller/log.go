...
func GetAllLogs(c *gin.Context) {
	...
	logs, err := model.GetAllLogs(logType, startTimestamp, endTimestamp, modelName, username, tokenName, p*common.ItemsPerPage, common.ItemsPerPage, channel, systemName, groupName)
	if err != nil {
